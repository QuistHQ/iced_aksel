...
pub fn draw_horizontal_line(
    ...
    mesh.vertices.extend_from_slice(&[
        SolidVertex2D { position: [x_start, top], color: packed_color },    // Top-Left
        SolidVertex2D { position: [x_start, bottom], color: packed_color }, // Bottom-Left
        SolidVertex2D { position: [x_end, top], color: packed_color },      // Top-Right
        SolidVertex2D { position: [x_end, bottom], color: packed_color },   // Bottom-Right
    ]);
...
pub fn draw_vertical_line(
    ...
    mesh.vertices.extend_from_slice(&[
        SolidVertex2D { position: [left, y_start], color: packed_color }, // Top-Left
        SolidVertex2D { position: [right, y_start], color: packed_color }, // Top-Right
        SolidVertex2D { position: [left, y_end], color: packed_color },   // Bottom-Left
        SolidVertex2D { position: [right, y_end], color: packed_color },  // Bottom-Right
    ]);
...
pub fn draw_horizontal_dashed_line(
    ...
    while current_x < end {
        ...
        mesh.vertices.extend_from_slice(&[
            SolidVertex2D { position: [current_x, top], color: packed_color },
            SolidVertex2D { position: [current_x, bottom], color: packed_color },
            SolidVertex2D { position: [seg_end_x, top], color: packed_color },
            SolidVertex2D { position: [seg_end_x, bottom], color: packed_color },
        ]);
...
pub fn draw_vertical_dashed_line(
    ...
    while current_y < end {
        ...
        mesh.vertices.extend_from_slice(&[
            SolidVertex2D { position: [left, current_y], color: packed_color },
            SolidVertex2D { position: [right, current_y], color: packed_color },
            SolidVertex2D { position: [left, seg_end_y], color: packed_color },
            SolidVertex2D { position: [right, seg_end_y], color: packed_color },
        ]);
